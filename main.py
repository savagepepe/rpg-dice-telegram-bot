...
- Supporto esplosioni (!)
- Immagine risultato:
  - Dimensioni maggiori (~550x320) per evitare sgranatura
  ...
  - Font numero interno alle sagome FISSO A 20 pt
...
def draw_fantasy_result(results: list[dict]) -> bytes:
    ...
    Genera un'immagine "scheda risultato":
      - 550x320 (immagine più grande, meno sgranata)
      ...
      - FONT NUMERO INTERNO FISSO A 20 pt
      - font “antico” (Palatino/Times/Georgia), grassetto
    ...
    # Font “antico”
    try:
        title_font = ImageFont.truetype("Palatino Linotype Bold.ttf", 18)
        label_font = ImageFont.truetype("Palatino Linotype Bold.ttf", 14)
        detail_font = ImageFont.truetype("Palatino Linotype.ttf", 12)
        result_font_base = ImageFont.truetype("Palatino Linotype Bold.ttf", 20)  # FISSO A 20
    except OSError:
        try:
            title_font = ImageFont.truetype("Times New Roman Bold.ttf", 18)
            label_font = ImageFont.truetype("Times New Roman Bold.ttf", 14)
            detail_font = ImageFont.truetype("Times New Roman.ttf", 12)
            result_font_base = ImageFont.truetype("Times New Roman Bold.ttf", 20)
        except OSError:
            try:
                title_font = ImageFont.truetype("Georgia Bold.ttf", 18)
                label_font = ImageFont.truetype("Georgia Bold.ttf", 14)
                detail_font = ImageFont.truetype("Georgia.ttf", 12)
                result_font_base = ImageFont.truetype("Georgia Bold.ttf", 20)
            except OSError:
