...
- Immagine risultato:
  ...
  - Sfondo NERO
  - Sagoma del dado in trasparenza, colore SEPPIA PIÙ¹ CHIARO
  - Numero del risultato AL CENTRO della sagoma (orizzontale e verticale)
  - Font numero interno alle sagome FISSO A 50 pt
...
def draw_fantasy_result(results: list[dict]) -> bytes:
    ...
    Genera un'immagine "scheda risultato":
      ...
      - etichette "Dado Tiro" / "Dado Fortuna" bilanciate sopra ogni dado
      - sfondo NERO
      - sagoma dado colore SEPPIA PIÙ¹ CHIARO in trasparenza
      - risultato al centro della sagoma (orizzontale e verticale)
      - FONT NUMERO INTERNO FISSO A 50 pt
      - font “antico” (Palatino/Times/Georgia), grassetto
    ...
    # Sfondo NERO
    bg_color = (10, 10, 12)
    # Sagoma dado: colore SEPPIA PIÙ¹ CHIARO
    shape_base = (180, 150, 100)  # più chiaro di (140,110,70)
    shape_alpha = 70
    ...
    # Font “antico” con dimensioni:
    #   title: 23, label: 19, detail: 17, result: 50
    try:
        title_font = ImageFont.truetype("Palatino Linotype Bold.ttf", 23)
        label_font = ImageFont.truetype("Palatino Linotype Bold.ttf", 19)
        detail_font = ImageFont.truetype("Palatino Linotype.ttf", 17)
        result_font_base = ImageFont.truetype("Palatino Linotype Bold.ttf", 50)
    except OSError:
        try:
            ...
            result_font_base = ImageFont.truetype("Times New Roman Bold.ttf", 50)
        except OSError:
            try:
                ...
                result_font_base = ImageFont.truetype("Georgia Bold.ttf", 50)
            except OSError:
