...
- Supporto esplosioni (!)
- Immagine risultato:
  - Dimensioni 650x380 (leggermente più grande per leggibilità¹¹)
  ...
  - Font numero interno alle sagome FISSO A 80 pt
...
def draw_fantasy_result(results: list[dict]) -> bytes:
    ...
    Genera un'immagine "scheda risultato":
      ...
      - FONT NUMERO INTERNO FISSO A 80 pt
      - font “antico” (Palatino/Times/Georgia), grassetto
    ...
    shape_base = (230, 215, 180)  # molto chiaro
    shape_alpha = 80
    ...
    #   title: 26, label: 20, detail: 18, result: 80
    try:
        title_font = ImageFont.truetype("Palatino Linotype Bold.ttf", 26)
        label_font = ImageFont.truetype("Palatino Linotype Bold.ttf", 20)
        detail_font = ImageFont.truetype("Palatino Linotype.ttf", 18)
        result_font_base = ImageFont.truetype("Palatino Linotype Bold.ttf", 80)
    except OSError:
        try:
            title_font = ImageFont.truetype("Times New Roman Bold.ttf", 26)
            label_font = ImageFont.truetype("Times New Roman Bold.ttf", 20)
            detail_font = ImageFont.truetype("Times New Roman.ttf", 18)
            result_font_base = ImageFont.truetype("Times New Roman Bold.ttf", 80)
        except OSError:
            try:
                title_font = ImageFont.truetype("Georgia Bold.ttf", 26)
                label_font = ImageFont.truetype("Georgia Bold.ttf", 20)
                detail_font = ImageFont.truetype("Georgia.ttf", 18)
                result_font_base = ImageFont.truetype("Georgia Bold.ttf", 80)
            except OSError:
